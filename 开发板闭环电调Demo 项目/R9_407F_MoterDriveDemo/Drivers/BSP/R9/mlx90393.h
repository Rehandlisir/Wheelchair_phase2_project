...
//IO接口定义
#define MLX90393_SDA_IN()  {GPIOC->MODER&=~(3<<(9*2));GPIOC->MODER|=0<<9*2;}	//PB9����ģʽ
#define MLX90393_SDA_OUT() {GPIOC->MODER&=~(3<<(9*2));GPIOC->MODER|=1<<9*2;} //PB9���ģʽ
//IO电平操作
#define MLX90393_SCL   PCout(8) //SCL
#define MLX90393_SDA   PCout(9) //SDA输出
#define MLX90393_READ_SDA  PCin(9)  //SDA输入
