/**
 * @FilePath     : /展示样机升级/R9_407F_num_2/Drivers/BSP/R9/moterdriver.c
 * @Description  :
 * @Author       : lisir lisir@rehand.com
 * @Version      : 0.0.1
 * @LastEditors  : error: error: git config user.name & please set dead value or install git && error: git config user.email & please set dead value or install git & please set dead value or install git
 * @LastEditTime : 2025-02-20 14:02:54
...
void car_move(double lduty_cycle, double rduty_cycle)//, uint8_t islmoter_reverse, uint8_t isrmoter_reverse, uint8_t isleftright_reverse)
{
    ...
    RightMoterMove(rduty_cycle);//,islmoter_reverse,isrmoter_reverse,isleftright_reverse);
}
