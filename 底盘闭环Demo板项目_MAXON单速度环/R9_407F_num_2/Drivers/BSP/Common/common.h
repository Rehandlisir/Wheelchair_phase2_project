...
int16_t local_slopelimitx(int16_t value, int16_t increvalue,int16_t decreasvalue);
int16_t local_slopelimity(int16_t value, int16_t increvalue,int16_t decreasvalue);
