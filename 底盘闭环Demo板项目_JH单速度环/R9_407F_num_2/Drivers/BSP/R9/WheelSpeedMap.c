/**
 * @FilePath     : /MDK-ARMc:/Users/fu/Desktop/底盘Demo/Wheelchair_phase2_project/底盘闭环Demo板项目/R9_407F_num_2/Drivers/BSP/R9/WheelSpeedMap.c
 * @Description  :  
 * @Author       : lisir
 * @Version      : V1.1
 * @LastEditors  : error: error: git config user.name & please set dead value or install git && error: git config user.email & please set dead value or install git & please set dead value or install git
 * @LastEditTime : 2024-12-19 14:04:13
...
void underpanExcute(void)
{
	...
	Struc_ActuPra_Int.adcx = local_slopelimitx(Struc_ActuPra_Int.adcx,50,50);  
	Struc_ActuPra_Int.adcy = local_slopelimity(Struc_ActuPra_Int.adcy,50,50);
