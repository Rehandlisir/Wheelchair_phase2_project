...
void sys_standby(void)
{
    ...
    ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1) |= ((0x3UL << (0U))));  
}
...
uint8_t sys_stm32_clock_init(void)  
{
    ...
    do { volatile uint32_t tmpreg; (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1))) & (~((0x3UL << (9U))))) | (((0x1UL << (9U))))))); tmpreg = ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1) & ((0x3UL << (9U)))); (void)tmpreg; } while(0);       

     
    rcc_osc_init.OscillatorType = 0x00000001U;         
    rcc_osc_init.HSEState = (0x1UL << (16U));                           
    rcc_osc_init.PLL.PLLState = 0x00000002U;                       
    rcc_osc_init.PLL.PLLSource = (0x3UL << (0U));               
    rcc_osc_init.PLL.PLLN = 28;
    rcc_osc_init.PLL.PLLM = 0x00000001U;
    rcc_osc_init.PLL.PLLP = 0x00000002U;
    rcc_osc_init.PLL.PLLQ = 0x00000002U;
		rcc_osc_init.PLL.PLLR = 0x00000002U;
    ...
    rcc_clk_init.ClockType = ( 0x00000001U                                     | 0x00000002U                                     | 0x00000004U                                     | 0x00000008U);




    rcc_clk_init.SYSCLKSource = (0x00000003U);          
    rcc_clk_init.AHBCLKDivider = (0x00000000U);                 
    rcc_clk_init.APB1CLKDivider = (0x00000000U);                  
    rcc_clk_init.APB2CLKDivider = (0x00000000U);                  
    ret = HAL_RCC_ClockConfig(&rcc_clk_init, (0x00000004U));    
    if(ret != HAL_OK)
    {
        return 1;                                                 
    }
