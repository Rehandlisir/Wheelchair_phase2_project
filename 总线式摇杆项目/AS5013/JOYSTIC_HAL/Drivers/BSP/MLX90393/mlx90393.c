...
void MLX90393_SDA_OUT(void)
{
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_7;                    //使用STM3cubemx是定义好的SDA_Pin为GPIO_PIN_8的标签
...
void vSetUpMlx90393(void)
{
    ...
    vCmdMlxAndWaiteErroTimes(MLX90393_ResetCommand, MLX90393slaveAdd_011, MlxErro_InCmdExitErro);//复位芯片
