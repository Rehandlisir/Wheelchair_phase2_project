# 1 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
...
# 26 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
...
# 27 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
...
int fputc(int ch, FILE *f)
{
    ...
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL))->TDR = (uint8_t)ch;              
    return ch;
}
...
void usart_init(uint32_t baudrate)
{
    ...
    g_uart1_handle.Instance = ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3800UL));                                        
    g_uart1_handle.Init.BaudRate = baudrate;                                   
    g_uart1_handle.Init.WordLength = 0x00000000U;                       
    g_uart1_handle.Init.StopBits = 0x00000000U;                            
    g_uart1_handle.Init.Parity = 0x00000000U;                             
    g_uart1_handle.Init.HwFlowCtl = 0x00000000U;                       
    g_uart1_handle.Init.Mode = ((0x1UL << (3U)) |(0x1UL << (2U)));                                
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
    ...
    {
        do{ do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) |= ((0x1UL << (14U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) & ((0x1UL << (14U)))); (void)tmpreg; } while(0); }while(0);                                   
        do{ do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0); }while(0);                              
        do{ do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0); }while(0);                              

        gpio_init_struct.Pin = ((uint16_t)0x0200);                
        gpio_init_struct.Mode = (0x00000002U);                 
        gpio_init_struct.Pull = (0x00000001U);                     
        gpio_init_struct.Speed = (0x00000002U);           
        gpio_init_struct.Alternate = ((uint8_t)0x07);           
        HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), &gpio_init_struct);    

        gpio_init_struct.Pin = ((uint16_t)0x0400);                
        gpio_init_struct.Alternate = ((uint8_t)0x07);           
        HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), &gpio_init_struct);    
