...
void btim_timx_int_init(uint16_t arr, uint16_t psc)
{
    g_timx_handler.Instance = ((TIM_TypeDef *) ((0x40000000UL) + 0x1000UL));                       
    g_timx_handler.Init.Prescaler = psc;                           
    g_timx_handler.Init.CounterMode = 0x00000000U;          
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim)
{
    ...
    {
        do{ do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (4U)))); (void)tmpreg; } while(0); }while(0);                      
