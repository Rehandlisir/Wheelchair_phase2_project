# 1 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_crc.c"
...
# 47 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_crc.c"
...
HAL_StatusTypeDef HAL_CRC_Init(CRC_HandleTypeDef *hcrc)
{
  ...
  ((void)0U);
  if (hcrc->Init.DefaultPolynomialUse == ((uint8_t)0x00U))
  {
     
    ((hcrc->Instance ->POL) = (0x04C11DB7U));
    (((hcrc->Instance ->CR)) = ((((((hcrc->Instance ->CR))) & (~((0x3UL << (3U))))) | (0x00000000U))));
  }
  else
  {
  ...
  ((void)0U);
  if (hcrc->Init.DefaultInitValueUse == ((uint8_t)0x00U))
  {
    ((hcrc->Instance ->INIT) = (0xFFFFFFFFU));
  }
  else
  {
    ((hcrc->Instance ->INIT) = (hcrc->Init . InitValue));
  }


   
  ((void)0U);
  (((hcrc->Instance ->CR)) = ((((((hcrc->Instance ->CR))) & (~((0x3UL << (5U))))) | (hcrc->Init . InputDataInversionMode))));

   
  ((void)0U);
  (((hcrc->Instance ->CR)) = ((((((hcrc->Instance ->CR))) & (~((0x1UL << (7U))))) | (hcrc->Init . OutputDataInversionMode))));
...
HAL_StatusTypeDef HAL_CRC_DeInit(CRC_HandleTypeDef *hcrc)
{
  ...
  ((hcrc->Instance ->IDR) &= ~((0xFFFFFFFFUL << (0U))));
...
static uint32_t CRC_Handle_8(CRC_HandleTypeDef *hcrc, uint8_t pBuffer[], uint32_t BufferLength)
{
  ...
  if ((BufferLength % 4U) != 0U)
  {
    ...
    {
      *(volatile uint8_t *)(volatile void *)(&hcrc->Instance->DR) = pBuffer[4U * i];          
    }
    if ((BufferLength % 4U) == 2U)
    {
      data = ((uint16_t)(pBuffer[4U * i]) << 8U) | (uint16_t)pBuffer[(4U * i) + 1U];
      pReg = (volatile uint16_t *)(volatile void *)(&hcrc->Instance->DR);                     
      *pReg = data;
    }
    if ((BufferLength % 4U) == 3U)
    {
      ...
      *(volatile uint8_t *)(volatile void *)(&hcrc->Instance->DR) = pBuffer[(4U * i) + 2U];   
    }
  }
