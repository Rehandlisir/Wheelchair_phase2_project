# 1 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_wwdg.c"
...
# 130 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_wwdg.c"
...
# 206 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_wwdg.c"
   
  HAL_WWDG_MspInit(hwwdg);


   
  ((hwwdg->Instance ->CR) = (((0x1UL << (7U)) | hwwdg->Init . Counter)));
...
# 316 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_wwdg.c"
...
void HAL_WWDG_IRQHandler(WWDG_HandleTypeDef *hwwdg)
{
  ...
  if ((((hwwdg)->Instance ->CFR & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) != RESET)
  {
     
    if ((((hwwdg)->Instance ->SR & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) != RESET)
    {
       
      ((hwwdg)->Instance ->SR = ~((0x1UL << (0U))));
