...
uint8_t MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Instance = ((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6400UL));
  hfdcan1.Init.ClockDivider = ((uint32_t)0x00000000U);
  hfdcan1.Init.FrameFormat = ((uint32_t)0x00000000U);
  hfdcan1.Init.Mode = ((uint32_t)0x00000000U);
  ...
  hfdcan1.Init.TxFifoQueueMode = ((uint32_t)0x00000000U);
  if (HAL_FDCAN_Init(&hfdcan1) != HAL_OK)
  {
    return 1;
  }
	FDCAN1_RXFilter.IdType=((uint32_t)0x00000000U);                       
	FDCAN1_RXFilter.FilterIndex=0;                                  
	FDCAN1_RXFilter.FilterType=((uint32_t)0x00000002U);                   
	FDCAN1_RXFilter.FilterConfig=((uint32_t)0x00000001U);           
    ...
    HAL_FDCAN_ActivateNotification(&hfdcan1,(0x1UL << (0U)),0);
}
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  if(fdcanHandle->Instance==((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6400UL)))
  {
    PeriphClkInit.PeriphClockSelection = 0x00001000U;
...
{	
  ...
  fdcan1_TxHeader.IdType = ((uint32_t)0x00000000U);
  fdcan1_TxHeader.TxFrameType = ((uint32_t)0x00000000U);
  fdcan1_TxHeader.DataLength = length;
  fdcan1_TxHeader.ErrorStateIndicator = ((uint32_t)0x00000000U);
  fdcan1_TxHeader.BitRateSwitch = ((uint32_t)0x00000000U);
  fdcan1_TxHeader.FDFormat = ((uint32_t)0x00000000U);
  fdcan1_TxHeader.TxEventFifoControl = ((uint32_t)0x00000000U);
...
{	
  ...
  if(HAL_FDCAN_GetRxMessage(&hfdcan1,((uint32_t)0x00000040U),&fdcan1_RxHeader,buf)!=HAL_OK)return 0;
...
void ASH5013_CAN_Trans(uint8_t id,int8_t x,int8_t y)
{
	int8_t src_data[8] = {x,y,id,0,0,0,0,0}; 
  uint8_t send_data[8];
	for (int i = 0; i < sizeof(src_data); i++) 
	{
    send_data[i] = (uint8_t)src_data[i]; 
	}
	
  FDCAN1_Send_Msg(id,send_data,((uint32_t)0x00080000U)); 
