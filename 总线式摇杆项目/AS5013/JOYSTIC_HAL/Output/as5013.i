...
void AS5013_Init(void)
{
	...
	do { 0 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); } while (0);
	delay_ms(1);
	do { 1 ? HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0100), GPIO_PIN_SET) : HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0100), GPIO_PIN_RESET); } while (0);
	
	uint8_t ctrl_reg1 = 0x02; 
	HAL_I2C_Mem_Write(&hi2c1, (0x41 << 1), (0x0f), (0x00000001U), &ctrl_reg1, 1, 100);
	delay_ms(1);
	
	uint8_t config_mode = 0x84; 
	HAL_I2C_Mem_Write(&hi2c1, (0x41 << 1), (0x0f), (0x00000001U), &config_mode, 1, 100);
	delay_ms(1);
	
	uint8_t ctrl_reg2 = 0x84; 
	HAL_I2C_Mem_Write(&hi2c1, (0x41 << 1), (0x2e), (0x00000001U), &ctrl_reg2, 1, 100);
	delay_ms(1);
    
	uint8_t scal_reg = 0x27;
	HAL_I2C_Mem_Write(&hi2c1, (0x41 << 1), (0x2d), (0x00000001U), &scal_reg, 1, 100);
	delay_ms(1);
}
...
void Read_XY(int8_t *x, int8_t *y)
{
	...
	HAL_I2C_Mem_Read(&hi2c1, (0x41 << 1), (0x10), (0x00000001U), (uint8_t *)x, 1, 100);
	
	HAL_I2C_Mem_Read(&hi2c1, (0x41 << 1), (0x11), (0x00000001U), (uint8_t *)y, 1, 100);
}
void ReadAs5013ID(uint8_t *ID)
{
	HAL_I2C_Mem_Read(&hi2c1, (0x41 << 1), (0x0c), (0x00000001U), (uint8_t *)ID, 1, 100);
}
...
{
	if ((((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 & (((uint16_t)0x0010))))
	{
		
		
		(((EXTI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0400UL))->PR1 = (((uint16_t)0x0010))); 
	}
}
