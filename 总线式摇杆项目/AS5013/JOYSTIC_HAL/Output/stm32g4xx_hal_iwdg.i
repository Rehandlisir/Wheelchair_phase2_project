...
# 105 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_iwdg.c"
...
HAL_StatusTypeDef HAL_IWDG_Init(IWDG_HandleTypeDef *hiwdg)
{
  ...
  (((hiwdg)->Instance ->KR) = (0x0000CCCCu));

  
 
  (((hiwdg)->Instance ->KR) = (0x00005555u));
  ...
  while ((hiwdg->Instance->SR & ((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U)))) != 0x00u)
  {
    if ((HAL_GetTick() - tickstart) > ((6UL * 256UL * 1000UL) / (32000UL)))
    {
      if ((hiwdg->Instance->SR & ((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U)))) != 0x00u)
      {
        return HAL_TIMEOUT;
      }
    }
