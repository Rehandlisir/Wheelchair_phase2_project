# 1 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"
...
# 170 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"
...
# 211 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"

# 218 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"

# 225 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"

# 237 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"
...
HAL_StatusTypeDef HAL_FDCAN_Init(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  ((void)0U);
  if (hfdcan->Instance == ((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6400UL)))
  {
    ((void)0U);
  }
  ((void)0U);
  ...
  ((void)0U);
  ((void)0U);
  if (hfdcan->Init.FrameFormat == ((uint32_t)((0x1UL << (8U)) | (0x1UL << (9U)))))
  {
    ((void)0U);
    ((void)0U);
    ((void)0U);
...
# 366 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"

   
  ((hfdcan->Instance ->CCCR) &= ~((0x1UL << (4U))));

   
  tickstart = HAL_GetTick();

   
  while ((hfdcan->Instance->CCCR & (0x1UL << (3U))) == (0x1UL << (3U)))
  {
    if ((HAL_GetTick() - tickstart) > 10U)
    {
       
      hfdcan->ErrorCode |= ((uint32_t)0x00000001U);
  ...
  ((hfdcan->Instance ->CCCR) |= ((0x1UL << (0U))));

   
  tickstart = HAL_GetTick();

   
  while ((hfdcan->Instance->CCCR & (0x1UL << (0U))) == 0U)
  {
  ...
  ((hfdcan->Instance ->CCCR) |= ((0x1UL << (1U))));

   
  if (hfdcan->Instance == ((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6400UL)))
  {
     
    ((FDCAN_Config_TypeDef *) ((0x40000000UL) + 0x6500UL))->CKDIV = hfdcan->Init.ClockDivider;
  }

   
  if (hfdcan->Init.AutoRetransmission == ENABLE)
  {
    ((hfdcan->Instance ->CCCR) &= ~((0x1UL << (6U))));
  }
  else
  {
    ((hfdcan->Instance ->CCCR) |= ((0x1UL << (6U))));
  ...
  {
    ((hfdcan->Instance ->CCCR) |= ((0x1UL << (14U))));
  }
  else
  {
    ((hfdcan->Instance ->CCCR) &= ~((0x1UL << (14U))));
  ...
  {
    ((hfdcan->Instance ->CCCR) &= ~((0x1UL << (12U))));
  }
  else
  {
    ((hfdcan->Instance ->CCCR) |= ((0x1UL << (12U))));
  ...
  (((hfdcan->Instance ->CCCR)) = ((((((hfdcan->Instance ->CCCR))) & (~(((uint32_t)((0x1UL << (8U)) | (0x1UL << (9U))))))) | (hfdcan->Init . FrameFormat))));

   
  ((hfdcan->Instance ->CCCR) &= ~(((0x1UL << (7U)) | (0x1UL << (5U)) | (0x1UL << (2U)))));
  ((hfdcan->Instance ->TEST) &= ~((0x1UL << (4U))));
  ...
  if (hfdcan->Init.Mode == ((uint32_t)0x00000001U))
  {
     
    ((hfdcan->Instance ->CCCR) |= ((0x1UL << (2U))));
  }
  else if (hfdcan->Init.Mode != ((uint32_t)0x00000000U))
  {
    if (hfdcan->Init.Mode != ((uint32_t)0x00000002U))
    {
       
      ((hfdcan->Instance ->CCCR) |= ((0x1UL << (7U))));

       
      ((hfdcan->Instance ->TEST) |= ((0x1UL << (4U))));

      if (hfdcan->Init.Mode == ((uint32_t)0x00000003U))
      {
        ((hfdcan->Instance ->CCCR) |= ((0x1UL << (5U))));
      }
    }
    else
    {
  ...
  hfdcan->Instance->NBTP = ((((uint32_t)hfdcan->Init.NominalSyncJumpWidth - 1U) << (25U)) |                             (((uint32_t)hfdcan->Init.NominalTimeSeg1 - 1U) << (8U))    |                             (((uint32_t)hfdcan->Init.NominalTimeSeg2 - 1U) << (0U))    |                             (((uint32_t)hfdcan->Init.NominalPrescaler - 1U) << (16U)));
  ...
  if (hfdcan->Init.FrameFormat == ((uint32_t)((0x1UL << (8U)) | (0x1UL << (9U)))))
  {
    hfdcan->Instance->DBTP = ((((uint32_t)hfdcan->Init.DataSyncJumpWidth - 1U) << (0U))  |                               (((uint32_t)hfdcan->Init.DataTimeSeg1 - 1U) << (8U))     |                               (((uint32_t)hfdcan->Init.DataTimeSeg2 - 1U) << (4U))     |                               (((uint32_t)hfdcan->Init.DataPrescaler - 1U) << (16U)));
  ...
  hfdcan->ErrorCode = ((uint32_t)0x00000000U);
...
HAL_StatusTypeDef HAL_FDCAN_DeInit(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  ((hfdcan->Instance ->ILE) &= ~((((uint32_t)0x00000001U) | ((uint32_t)0x00000002U))));


  if (hfdcan->MspDeInitCallback == 0)
  {
...
HAL_StatusTypeDef HAL_FDCAN_EnterPowerDownMode(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  while ((hfdcan->Instance->CCCR & (0x1UL << (3U))) == 0U)
  {
    if ((HAL_GetTick() - tickstart) > 10U)
    {
                                             ...
                                             void (* pCallback)(FDCAN_HandleTypeDef *_hFDCAN))
{
  ...
  if (pCallback == 0)
  {
    ...
    hfdcan->ErrorCode |= ((uint32_t)0x00000100U);
...
HAL_StatusTypeDef HAL_FDCAN_ConfigFilter(FDCAN_HandleTypeDef *hfdcan, FDCAN_FilterTypeDef *sFilterConfig)
{
  ...
  if ((state == HAL_FDCAN_STATE_READY) || (state == HAL_FDCAN_STATE_BUSY))
  {
    ...
    if (sFilterConfig->IdType == ((uint32_t)0x00000000U))
    {
      ...
      FilterAddress = (uint32_t *)(hfdcan->msgRam.StandardFilterSA + (sFilterConfig->FilterIndex * ( 1U * 4U)));
    ...
    else  
    {
      ...
      FilterAddress = (uint32_t *)(hfdcan->msgRam.ExtendedFilterSA + (sFilterConfig->FilterIndex * ( 2U * 4U)));
  ...
  else
  {
    ...
    hfdcan->ErrorCode |= ((uint32_t)0x00000002U);
                                               ...
                                               uint32_t RejectRemoteExt)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    (((hfdcan->Instance ->RXGFC)) = ((((((hfdcan->Instance ->RXGFC))) & (~(((0x3UL << (4U)) | (0x3UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U)))))) | (((NonMatchingStd << (4U)) | (NonMatchingExt << (2U)) | (RejectRemoteStd << (1U)) | (RejectRemoteExt << (0U)))))));
# 1403 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"
  ...
  else
  {
    ...
    hfdcan->ErrorCode |= ((uint32_t)0x00000004U);
...
HAL_StatusTypeDef HAL_FDCAN_ConfigRxFifoOverwrite(FDCAN_HandleTypeDef *hfdcan, uint32_t RxFifo, uint32_t OperationMode)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    if (RxFifo == ((uint32_t)0x00000040U))
    {
       
      (((hfdcan->Instance ->RXGFC)) = ((((((hfdcan->Instance ->RXGFC))) & (~((0x1UL << (9U))))) | ((OperationMode << (9U))))));
    }
    else  
    {
       
      (((hfdcan->Instance ->RXGFC)) = ((((((hfdcan->Instance ->RXGFC))) & (~((0x1UL << (8U))))) | ((OperationMode << (8U))))));
    }
...
HAL_StatusTypeDef HAL_FDCAN_ConfigRamWatchdog(FDCAN_HandleTypeDef *hfdcan, uint32_t CounterStartValue)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    (((hfdcan->Instance ->RWD)) = ((((((hfdcan->Instance ->RWD))) & (~((0xFFUL << (0U))))) | (CounterStartValue))));
...
HAL_StatusTypeDef HAL_FDCAN_ConfigTimestampCounter(FDCAN_HandleTypeDef *hfdcan, uint32_t TimestampPrescaler)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    (((hfdcan->Instance ->TSCC)) = ((((((hfdcan->Instance ->TSCC))) & (~((0xFUL << (16U))))) | (TimestampPrescaler))));
...
HAL_StatusTypeDef HAL_FDCAN_EnableTimestampCounter(FDCAN_HandleTypeDef *hfdcan, uint32_t TimestampOperation)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    (((hfdcan->Instance ->TSCC)) = ((((((hfdcan->Instance ->TSCC))) & (~((0x3UL << (0U))))) | (TimestampOperation))));
...
HAL_StatusTypeDef HAL_FDCAN_ResetTimestampCounter(FDCAN_HandleTypeDef *hfdcan)
{
  if ((hfdcan->Instance->TSCC & (0x3UL << (0U))) != ((uint32_t)0x00000002U))
  {
    
 
    ((hfdcan->Instance ->TSCV) = (0x0));
  }
  else
  {
    
 
    hfdcan->ErrorCode |= ((uint32_t)0x00000010U);
                                                 ...
                                                 uint32_t TimeoutPeriod)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    (((hfdcan->Instance ->TOCC)) = ((((((hfdcan->Instance ->TOCC))) & (~(((0x3UL << (1U)) | (0xFFFFUL << (16U)))))) | ((TimeoutOperation | (TimeoutPeriod << (16U)))))));
...
HAL_StatusTypeDef HAL_FDCAN_ResetTimeoutCounter(FDCAN_HandleTypeDef *hfdcan)
{
  if ((hfdcan->Instance->TOCC & (0x3UL << (1U))) == ((uint32_t)0x00000000U))
  {
     
    ((hfdcan->Instance ->TOCV) = (0x0));
                                                      ...
                                                      uint32_t TdcFilter)
{
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    hfdcan->Instance->TDCR = ((TdcFilter << (0U)) | (TdcOffset << (8U)));
...
HAL_StatusTypeDef HAL_FDCAN_EnableTxDelayCompensation(FDCAN_HandleTypeDef *hfdcan)
{
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    ((hfdcan->Instance ->DBTP) |= ((0x1UL << (23U))));
...
HAL_StatusTypeDef HAL_FDCAN_EnableISOMode(FDCAN_HandleTypeDef *hfdcan)
{
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    ((hfdcan->Instance ->CCCR) &= ~((0x1UL << (15U))));
...
HAL_StatusTypeDef HAL_FDCAN_EnableEdgeFiltering(FDCAN_HandleTypeDef *hfdcan)
{
  if (hfdcan->State == HAL_FDCAN_STATE_READY)
  {
    ...
    ((hfdcan->Instance ->CCCR) |= ((0x1UL << (13U))));
...
HAL_StatusTypeDef HAL_FDCAN_Stop(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  else
  {
    ...
    hfdcan->ErrorCode |= ((uint32_t)0x00000008U);
                                                ...
                                                uint8_t *pTxData)
{
  ...
  ((void)0U);
  if (pTxHeader->IdType == ((uint32_t)0x00000000U))
  {
    ((void)0U);
  }
  else  
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_BUSY)
  {
    ...
    if ((hfdcan->Instance->TXFQS & (0x1UL << (21U))) != 0U)
    {
       
      hfdcan->ErrorCode |= ((uint32_t)0x00000200U);
    ...
    else
    {
      ...
      PutIndex = ((hfdcan->Instance->TXFQS & (0x3UL << (16U))) >> (16U));
                                         ...
                                         FDCAN_RxHeaderTypeDef *pRxHeader, uint8_t *pRxData)
{
  ...
  {
    if (RxLocation == ((uint32_t)0x00000040U))  
    {
       
      if ((hfdcan->Instance->RXF0S & (0xFUL << (0U))) == 0U)
      {
      ...
      else
      {
        ...
        GetIndex = ((hfdcan->Instance->RXF0S & (0x3UL << (8U))) >> (8U));
        RxAddress = (uint32_t *)(hfdcan->msgRam.RxFIFO0SA + (GetIndex * (18U * 4U)));
      }
    }
    else  
    {
       
      if ((hfdcan->Instance->RXF1S & (0xFUL << (0U))) == 0U)
      {
      ...
      else
      {
        ...
        GetIndex = ((hfdcan->Instance->RXF1S & (0x3UL << (8U))) >> (8U));
        RxAddress = (uint32_t *)(hfdcan->msgRam.RxFIFO1SA + (GetIndex * (18U * 4U)));
      }
    }
    ...
    if (pRxHeader->IdType == ((uint32_t)0x00000000U))  
    {
      pRxHeader->Identifier = ((*RxAddress & ((uint32_t)0x1FFC0000U)) >> 18U);
    }
    else  
    {
      pRxHeader->Identifier = (*RxAddress & ((uint32_t)0x1FFFFFFFU));
    }
    ...
    pRxHeader->DataLength = (*RxAddress & ((uint32_t)0x000F0000U));
...
HAL_StatusTypeDef HAL_FDCAN_GetTxEvent(FDCAN_HandleTypeDef *hfdcan, FDCAN_TxEventFifoTypeDef *pTxEvent)
{
  ...
  if (state == HAL_FDCAN_STATE_BUSY)
  {
    ...
    if ((hfdcan->Instance->TXEFS & (0x7UL << (0U))) == 0U)
    {
    ...
    GetIndex = ((hfdcan->Instance->TXEFS & (0x3UL << (8U))) >> (8U));
    TxEventAddress = (uint32_t *)(hfdcan->msgRam.TxEventFIFOSA + (GetIndex * ( 2U * 4U)));

     
    pTxEvent->IdType = *TxEventAddress & ((uint32_t)0x40000000U);

     
    if (pTxEvent->IdType == ((uint32_t)0x00000000U))  
    {
      pTxEvent->Identifier = ((*TxEventAddress & ((uint32_t)0x1FFC0000U)) >> 18U);
    }
    else  
    {
      pTxEvent->Identifier = (*TxEventAddress & ((uint32_t)0x1FFFFFFFU));
    }

     
    pTxEvent->TxFrameType = (*TxEventAddress & ((uint32_t)0x20000000U));

     
    pTxEvent->ErrorStateIndicator = (*TxEventAddress & ((uint32_t)0x80000000U));

     
    TxEventAddress++;

     
    pTxEvent->TxTimestamp = (*TxEventAddress & ((uint32_t)0x0000FFFFU));

     
    pTxEvent->DataLength = (*TxEventAddress & ((uint32_t)0x000F0000U));

     
    pTxEvent->BitRateSwitch = (*TxEventAddress & ((uint32_t)0x00100000U));

     
    pTxEvent->FDFormat = (*TxEventAddress & ((uint32_t)0x00200000U));

     
    pTxEvent->EventType = (*TxEventAddress & ((uint32_t)0x00C00000U));

     
    pTxEvent->MessageMarker = ((*TxEventAddress & ((uint32_t)0xFF000000U)) >> 24U);
...
HAL_StatusTypeDef HAL_FDCAN_GetHighPriorityMessageStatus(FDCAN_HandleTypeDef *hfdcan,
                                                         FDCAN_HpMsgStatusTypeDef *HpMsgStatus)
{
  HpMsgStatus->FilterList = ((hfdcan->Instance->HPMS & (0x1UL << (15U))) >> (15U));
  HpMsgStatus->FilterIndex = ((hfdcan->Instance->HPMS & (0x1FUL << (8U))) >> (8U));
  HpMsgStatus->MessageStorage = (hfdcan->Instance->HPMS & (0x3UL << (6U)));
  HpMsgStatus->MessageIndex = (hfdcan->Instance->HPMS & (0x7UL << (0U)));
...
HAL_StatusTypeDef HAL_FDCAN_GetProtocolStatus(FDCAN_HandleTypeDef *hfdcan, FDCAN_ProtocolStatusTypeDef *ProtocolStatus)
{
  ...
  StatusReg = ((hfdcan->Instance ->PSR));

   
  ProtocolStatus->LastErrorCode = (StatusReg & (0x7UL << (0U)));
  ProtocolStatus->DataLastErrorCode = ((StatusReg & (0x7UL << (8U))) >> (8U));
  ProtocolStatus->Activity = (StatusReg & (0x3UL << (3U)));
  ProtocolStatus->ErrorPassive = ((StatusReg & (0x1UL << (5U))) >> (5U));
  ProtocolStatus->Warning = ((StatusReg & (0x1UL << (6U))) >> (6U));
  ProtocolStatus->BusOff = ((StatusReg & (0x1UL << (7U))) >> (7U));
  ProtocolStatus->RxESIflag = ((StatusReg & (0x1UL << (11U))) >> (11U));
  ProtocolStatus->RxBRSflag = ((StatusReg & (0x1UL << (12U))) >> (12U));
  ProtocolStatus->RxFDFflag = ((StatusReg & (0x1UL << (13U))) >> (13U));
  ProtocolStatus->ProtocolException = ((StatusReg & (0x1UL << (14U))) >> (14U));
  ProtocolStatus->TDCvalue = ((StatusReg & (0x7FUL << (16U))) >> (16U));
...
HAL_StatusTypeDef HAL_FDCAN_GetErrorCounters(FDCAN_HandleTypeDef *hfdcan, FDCAN_ErrorCountersTypeDef *ErrorCounters)
{
  ...
  CountersReg = ((hfdcan->Instance ->ECR));

   
  ErrorCounters->TxErrorCnt = ((CountersReg & (0xFFUL << (0U))) >> (0U));
  ErrorCounters->RxErrorCnt = ((CountersReg & (0x7FUL << (8U))) >> (8U));
  ErrorCounters->RxErrorPassive = ((CountersReg & (0x1UL << (15U))) >> (15U));
  ErrorCounters->ErrorLogging = ((CountersReg & (0xFFUL << (16U))) >> (16U));
...
uint32_t HAL_FDCAN_GetRxFifoFillLevel(FDCAN_HandleTypeDef *hfdcan, uint32_t RxFifo)
{
  ...
  if (RxFifo == ((uint32_t)0x00000040U))
  {
    FillLevel = hfdcan->Instance->RXF0S & (0xFUL << (0U));
  }
  else  
  {
    FillLevel = hfdcan->Instance->RXF1S & (0xFUL << (0U));
  }
...
uint32_t HAL_FDCAN_GetTxFifoFreeLevel(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  FreeLevel = hfdcan->Instance->TXFQS & (0x7UL << (0U));
...
uint32_t HAL_FDCAN_IsRestrictedOperationMode(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  OperationMode = ((hfdcan->Instance->CCCR & (0x1UL << (2U))) >> (2U));
...
HAL_StatusTypeDef HAL_FDCAN_ConfigInterruptLines(FDCAN_HandleTypeDef *hfdcan, uint32_t ITList, uint32_t InterruptLine)
{
  ...
  if ((state == HAL_FDCAN_STATE_READY) || (state == HAL_FDCAN_STATE_BUSY))
  {
    ...
    if (InterruptLine == ((uint32_t)0x00000001U))
    {
      ((hfdcan->Instance ->ILS) &= ~(ITList));
    }
    else  
    {
      ((hfdcan->Instance ->ILS) |= (ITList));
                                                 ...
                                                 uint32_t BufferIndexes)
{
  ...
  ((void)0U);
  if ((ActiveITs & ((0x1UL << (7U)) | (0x1UL << (8U)))) != 0U)
  {
    ((void)0U);
  }
  ...
  if ((state == HAL_FDCAN_STATE_READY) || (state == HAL_FDCAN_STATE_BUSY))
  {
    ...
    if ((((ActiveITs & ((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U)))) != 0U)
         && (((ITs_lines_selection) & (0x1UL << (0U))) == 0U)) ||         (((ActiveITs & ((0x1UL << (5U)) | (0x1UL << (4U)) | (0x1UL << (3U))))       != 0U)

         && (((ITs_lines_selection) & (0x1UL << (1U))) == 0U)) ||         (((ActiveITs & ((0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U))))           != 0U)

         && (((ITs_lines_selection) & (0x1UL << (2U)))     == 0U)) ||         (((ActiveITs & ((0x1UL << (12U)) | (0x1UL << (11U)) | (0x1UL << (10U)) | (0x1UL << (9U))))  != 0U)

         && (((ITs_lines_selection) & (0x1UL << (3U)))  == 0U)) ||         (((ActiveITs & ((0x1UL << (15U)) | (0x1UL << (14U)) | (0x1UL << (13U))))           != 0U)

         && (((ITs_lines_selection) & (0x1UL << (4U)))           == 0U)) ||         (((ActiveITs & ((0x1UL << (17U)) | (0x1UL << (16U)))) != 0U)

         && (((ITs_lines_selection) & (0x1UL << (5U))) == 0U)) ||         (((ActiveITs & ((0x1UL << (23U)) | (0x1UL << (22U)) | (0x1UL << (21U)) | (0x1UL << (20U)) | (0x1UL << (19U)) | (0x1UL << (18U)))) != 0U)

         && (((ITs_lines_selection) & (0x1UL << (6U))) == 0U)))
    {
       
      ((hfdcan->Instance ->ILE) |= (((uint32_t)0x00000001U)));
    }
    if ((((ActiveITs & ((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U))))       != 0U)
         && (((ITs_lines_selection) & (0x1UL << (0U)))      != 0U)) ||         (((ActiveITs & ((0x1UL << (5U)) | (0x1UL << (4U)) | (0x1UL << (3U))))       != 0U)
         ...
         && (((ITs_lines_selection) & (0x1UL << (6U))) != 0U)))
    {
      ...
      ((hfdcan->Instance ->ILE) |= (((uint32_t)0x00000002U)));
    }

    if ((ActiveITs & (0x1UL << (7U))) != 0U)
    {
      
 
      ((hfdcan->Instance ->TXBTIE) |= (BufferIndexes));
    }

    if ((ActiveITs & (0x1UL << (8U))) != 0U)
    {
      
 
      ((hfdcan->Instance ->TXBCIE) |= (BufferIndexes));
    }

     
    (hfdcan)->Instance ->IE |= (ActiveITs);
...
HAL_StatusTypeDef HAL_FDCAN_DeactivateNotification(FDCAN_HandleTypeDef *hfdcan, uint32_t InactiveITs)
{
  ...
  if ((state == HAL_FDCAN_STATE_READY) || (state == HAL_FDCAN_STATE_BUSY))
  {
    ...
    ((hfdcan)->Instance ->IE) &= ~(InactiveITs);

    if ((InactiveITs & (0x1UL << (7U))) != 0U)
    {
       
      ((hfdcan->Instance ->TXBTIE) = (0x0));
    }

    if ((InactiveITs & (0x1UL << (8U))) != 0U)
    {
       
      ((hfdcan->Instance ->TXBCIE) = (0x0));
    }
    ...
    if ((((ITs_enabled & ((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U))))       != 0U)
         && (((ITs_lines_selection) & (0x1UL << (0U)))       == 0U)) ||         (((ITs_enabled & ((0x1UL << (5U)) | (0x1UL << (4U)) | (0x1UL << (3U))))       != 0U)

         && (((ITs_lines_selection) & (0x1UL << (1U)))       == 0U)) ||         (((ITs_enabled & ((0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U))))           != 0U)

         && (((ITs_lines_selection) & (0x1UL << (2U)))           == 0U)) ||         (((ITs_enabled & ((0x1UL << (12U)) | (0x1UL << (11U)) | (0x1UL << (10U)) | (0x1UL << (9U))))  != 0U)

         && (((ITs_lines_selection) & (0x1UL << (3U)))  == 0U)) ||         (((ITs_enabled & ((0x1UL << (15U)) | (0x1UL << (14U)) | (0x1UL << (13U))))           != 0U)

         && (((ITs_lines_selection) & (0x1UL << (4U)))           == 0U)) ||         (((ITs_enabled & ((0x1UL << (17U)) | (0x1UL << (16U)))) != 0U)

         && (((ITs_lines_selection) & (0x1UL << (5U))) == 0U)) ||         (((ITs_enabled & ((0x1UL << (23U)) | (0x1UL << (22U)) | (0x1UL << (21U)) | (0x1UL << (20U)) | (0x1UL << (19U)) | (0x1UL << (18U)))) != 0U)
...
void HAL_FDCAN_IRQHandler(FDCAN_HandleTypeDef *hfdcan)
{
  ...
  TxEventFifoITs = hfdcan->Instance->IR & ((0x1UL << (12U)) | (0x1UL << (11U)) | (0x1UL << (10U)));
  TxEventFifoITs &= hfdcan->Instance->IE;
  RxFifo0ITs = hfdcan->Instance->IR & ((0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U)));
  RxFifo0ITs &= hfdcan->Instance->IE;
  RxFifo1ITs = hfdcan->Instance->IR & ((0x1UL << (5U)) | (0x1UL << (4U)) | (0x1UL << (3U)));
  RxFifo1ITs &= hfdcan->Instance->IE;
  Errors = hfdcan->Instance->IR & ((0x1UL << (16U)) | (0x1UL << (20U)) | (0x1UL << (21U)) | (0x1UL << (22U)) | (0x1UL << (23U)));
  Errors &= hfdcan->Instance->IE;
  ErrorStatusITs = hfdcan->Instance->IR & ((0x1UL << (17U)) | (0x1UL << (18U)) | (0x1UL << (19U)));
  ErrorStatusITs &= hfdcan->Instance->IE;

   
  if (((hfdcan)->Instance ->IR & ((0x1UL << (6U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (6U)))) != 0U)
    {
       
      ((hfdcan)->Instance ->IR) = ((0x1UL << (6U)));
  ...
  if (((hfdcan)->Instance ->IR & ((0x1UL << (8U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (8U)))) != 0U)
    {
  ...
  if (TxEventFifoITs != 0U)
  {
    ...
    ((hfdcan)->Instance ->IR) = (TxEventFifoITs);
  ...
  if (((hfdcan)->Instance ->IR & ((0x1UL << (9U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (9U)))) != 0U)
    {
       
      ((hfdcan)->Instance ->IR) = ((0x1UL << (9U)));
  ...
  if (((hfdcan)->Instance ->IR & ((0x1UL << (7U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (7U)))) != 0U)
    {
  ...
  if (((hfdcan)->Instance ->IR & ((0x1UL << (13U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (13U)))) != 0U)
    {
       
      ((hfdcan)->Instance ->IR) = ((0x1UL << (13U)));
  ...
  if (((hfdcan)->Instance ->IR & ((0x1UL << (15U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (15U)))) != 0U)
    {
       
      ((hfdcan)->Instance ->IR) = ((0x1UL << (15U)));
  ...
  if (((hfdcan)->Instance ->IR & ((0x1UL << (14U)))) != 0U)
  {
    if (((hfdcan)->Instance ->IE & ((0x1UL << (14U)))) != 0U)
    {
       
      ((hfdcan)->Instance ->IR) = ((0x1UL << (14U)));

       
      hfdcan->ErrorCode |= ((uint32_t)0x00000080U);
    }
  }
  ...
  if (ErrorStatusITs != 0U)
  {
    ...
    ((hfdcan)->Instance ->IR) = (ErrorStatusITs);
  ...
  if (Errors != 0U)
  {
    ...
    ((hfdcan)->Instance ->IR) = (Errors);

     
    hfdcan->ErrorCode |= Errors;
  }

  if (hfdcan->ErrorCode != ((uint32_t)0x00000000U))
  {
...
{
  uint32_t RAMcounter;
  uint32_t SramCanInstanceBase = ((0x40000000UL) + 0xA400UL);
# 3413 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_fdcan.c"

   
  hfdcan->msgRam.StandardFilterSA = SramCanInstanceBase + ((uint32_t)0);

   
  (((hfdcan->Instance ->RXGFC)) = ((((((hfdcan->Instance ->RXGFC))) & (~((0x1FUL << (16U))))) | ((hfdcan->Init . StdFiltersNbr << (16U))))));

   
  hfdcan->msgRam.ExtendedFilterSA = SramCanInstanceBase + ((uint32_t)(((uint32_t)0) + ((28U) * ( 1U * 4U))));

   
  (((hfdcan->Instance ->RXGFC)) = ((((((hfdcan->Instance ->RXGFC))) & (~((0xFUL << (24U))))) | ((hfdcan->Init . ExtFiltersNbr << (24U))))));

   
  hfdcan->msgRam.RxFIFO0SA = SramCanInstanceBase + ((uint32_t)(((uint32_t)(((uint32_t)0) + ((28U) * ( 1U * 4U)))) + (( 8U) * ( 2U * 4U))));

   
  hfdcan->msgRam.RxFIFO1SA = SramCanInstanceBase + ((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)0) + ((28U) * ( 1U * 4U)))) + (( 8U) * ( 2U * 4U)))) + (( 3U) * (18U * 4U))));

   
  hfdcan->msgRam.TxEventFIFOSA = SramCanInstanceBase + ((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)0) + ((28U) * ( 1U * 4U)))) + (( 8U) * ( 2U * 4U)))) + (( 3U) * (18U * 4U)))) + (( 3U) * (18U * 4U))));

   
  hfdcan->msgRam.TxFIFOQSA = SramCanInstanceBase + ((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)0) + ((28U) * ( 1U * 4U)))) + (( 8U) * ( 2U * 4U)))) + (( 3U) * (18U * 4U)))) + (( 3U) * (18U * 4U)))) + (( 3U) * ( 2U * 4U))));

   
  for (RAMcounter = SramCanInstanceBase; RAMcounter < (SramCanInstanceBase + ((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)(((uint32_t)0) + ((28U) * ( 1U * 4U)))) + (( 8U) * ( 2U * 4U)))) + (( 3U) * (18U * 4U)))) + (( 3U) * (18U * 4U)))) + (( 3U) * ( 2U * 4U)))) + (( 3U) * (18U * 4U))))); RAMcounter += 4U)
  {
                                   ...
                                   uint32_t BufferIndex)
{
  ...
  TxAddress = (uint32_t *)(hfdcan->msgRam.TxFIFOQSA + (BufferIndex * (18U * 4U)));
