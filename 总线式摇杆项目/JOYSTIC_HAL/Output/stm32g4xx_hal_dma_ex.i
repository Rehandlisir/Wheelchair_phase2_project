                                                      ...
                                                      HAL_DMA_MuxRequestGeneratorConfigTypeDef *pRequestGeneratorConfig)
{
  ...
  if ((hdma->State == HAL_DMA_STATE_READY) && (hdma->DMAmuxRequestGen != 0U))
  {
    ...
    hdma->DMAmuxRequestGen->RGCR = pRequestGeneratorConfig->SignalID |                                    ((pRequestGeneratorConfig->RequestNumber - 1U) << ((__clz(__rbit((0x1FUL << (19U))))) & 0x1FU)) |                                    pRequestGeneratorConfig->Polarity;
