# 1 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_usart.c"
...
# 141 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_usart.c"
...
# 303 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_usart.c"
...
# 363 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_usart.c"
   
  HAL_USART_MspDeInit(husart);


  husart->ErrorCode = (0x00000000U);
  husart->State = HAL_USART_STATE_RESET;

   
  do{ (husart)->Lock = HAL_UNLOCKED; }while (0U);
...
# 654 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_usart.c"
...
HAL_StatusTypeDef HAL_USART_Transmit(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    do{ if((husart)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (husart)->Lock = HAL_LOCKED; } }while (0U);
    ...
    if ((husart->Init.WordLength == ((0x1UL << (12U)))) && (husart->Init.Parity == 0x00000000U))
    {
      ptxdata8bits  = 0;
...
HAL_StatusTypeDef HAL_USART_Receive(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    do { if ((husart)->Init . WordLength == ((0x1UL << (12U)))) { if ((husart)->Init . Parity == 0x00000000U) { (husart)->Mask = 0x01FFU; } else { (husart)->Mask = 0x00FFU; } } else if ((husart)->Init . WordLength == (0x00000000U)) { if ((husart)->Init . Parity == 0x00000000U) { (husart)->Mask = 0x00FFU; } else { (husart)->Mask = 0x007FU; } } else if ((husart)->Init . WordLength == ((0x1UL << (28U)))) { if ((husart)->Init . Parity == 0x00000000U) { (husart)->Mask = 0x007FU; } else { (husart)->Mask = 0x003FU; } } else { (husart)->Mask = 0x0000U; } } while(0U);
    uhMask = husart->Mask;
...
HAL_StatusTypeDef HAL_USART_Transmit_IT(USART_HandleTypeDef *husart, uint8_t *pTxData, uint16_t Size)
{
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    if (husart->FifoMode == (0x1UL << (29U)))
    {
      ...
      (((((0x1B77U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 |= (1U << ((0x1B77U) & 0x001FU))): ((((0x1B77U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 |= (1U << ((0x1B77U) & 0x001FU))): ((husart)->Instance ->CR3 |= (1U << ((0x1B77U) & 0x001FU))));
    }
    else
    {
      ...
      (((((0x0727U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 |= (1U << ((0x0727U) & 0x001FU))): ((((0x0727U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 |= (1U << ((0x0727U) & 0x001FU))): ((husart)->Instance ->CR3 |= (1U << ((0x0727U) & 0x001FU))));
    }
...
void HAL_USART_IRQHandler(USART_HandleTypeDef *husart)
{
          ...
          || ((cr1its & ((0x1UL << (5U)) | (0x1UL << (8U)))) != 0U)))
  {
    ...
    if (((isrflags & (0x1UL << (13U))) != 0U) && ((cr3its & (0x1UL << (0U))) != 0U))
    {
      ...
      {
        (((husart))->Instance ->ICR = ((0x1UL << (13U))));
        husart->ErrorCode |= (0x00000020U);
      }
    }

     
    if (husart->ErrorCode != (0x00000000U))
    {
      ...
      errorcode = husart->ErrorCode & (0x00000008U);
      if (((((husart->Instance ->CR3) & ((0x1UL << (6U)))) == ((0x1UL << (6U))))) ||
          (errorcode != 0U))
      {
...
# 2503 "..\\..\\Drivers\\STM32G4xx_HAL_Driver\\Src\\stm32g4xx_hal_usart.c"
...
static void USART_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((((hdma->Instance ->CCR) & ((0x1UL << (5U)))) == 0U))
  {
    ...
    if (husart->State == HAL_USART_STATE_BUSY_TX)
    {
      ...
      (((((0x0626U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 |= (1U << ((0x0626U) & 0x001FU))): ((((0x0626U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 |= (1U << ((0x0626U) & 0x001FU))): ((husart)->Instance ->CR3 |= (1U << ((0x0626U) & 0x001FU))));
    }
  }
...
static HAL_StatusTypeDef USART_SetConfig(USART_HandleTypeDef *husart)
{
  ...
  (((husart->Instance ->CR1)) = ((((((husart->Instance ->CR1))) & (~(((uint32_t)((0x10001UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (15U)) | (0x1UL << (29U)) ))))) | (tmpreg))));
...
static void USART_EndTransmit_IT(USART_HandleTypeDef *husart)
{
  ...
  (((((0x0060U) & 0x00E0U) >> 5U) == 1U)? ((husart)->Instance ->CR1 &= ~ (1U << ((0x0060U) & 0x001FU))): ((((0x0060U) & 0x00E0U) >> 5U) == 2U)? ((husart)->Instance ->CR2 &= ~ (1U << ((0x0060U) & 0x001FU))): ((husart)->Instance ->CR3 &= ~ (1U << ((0x0060U) & 0x001FU))));
