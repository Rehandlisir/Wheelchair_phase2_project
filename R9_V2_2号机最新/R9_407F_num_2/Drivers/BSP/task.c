...
{
    /*座椅模块监测*/
	//  printf("/*R9DataVisual:%d,%d,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f*/\n",
	...
	//  legkinematicspra.x_o,legkinematicspra.y_o,chairkinematicspra.y_o,chairkinematicspra.theta_x2X,
    //  g_slaveReg[25]/100.0,g_slaveReg[24]/100.0,g_slaveReg[26]/100.0); 
   /*上下位机通讯状态监测*/
	// printf("/*R9StateVisual:%d,%d,%d,%d,%d,%d*/\n",
	// g_slaveReg[2],g_slaveReg[4],g_slaveReg[27],g_slaveReg[75],
	// g_slaveReg[78],comheartstate.Current_Com);  /*状态量监测*/  

    /*底盘电机监测*/
	 printf("/*R9car:%d,%d,%f,%f,%f,%f,%f*/\n",\
	 mlxdata.xdata,mlxdata.ydata,\
	 Struc_ActuPra_Out.steering_angle,\
	 Struc_ActuPra_Out.L_Velocity,Struc_ActuPra_Out.R_Velocity,\
	 Struc_ActuPra_Out.L_Dutycycle*100,Struc_ActuPra_Out.R_Dutycycle*100);
