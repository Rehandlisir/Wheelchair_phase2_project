...
#define  INCR_LOCT_SELECT  1         /* 0：位置式 ，1：增量式 */
    ...
    // /* 增量式PID 速度环参数相关宏 */
    #define  S_KP     0.008f                /* P参数 0.010f */
    #define  S_KI      0.0012f              /* I参数0.0015f  */
    #define  S_KD      0.0f               /* D参数*/
    #define  S_SMAPLSE_PID_SPEED  10      /* 采样周期 单位ms*/


    /* 定义电流环（内环）PID参数相关宏 */
    #define  C_KP      0.0625f             /* P参数 */
    #define  C_KI      0.00085f             /* I参数 */
    #define  C_KD      0.005f             /* D参数 */
#else
